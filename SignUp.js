...
<button type="button" class="btn btn-light btn-floating mx-1">
          ...
          <div class="form-group">  
                    <label for="exampleInputEmail1" class="para"> Enter Username </label>  
                    <input type="text" class="form-control form-control-sm hi"  id="exampleInputUsername1" autoComplete="off"  value={user.username} onChange={handelinput} required name="username" />  
          </div> 
          <br></br>
<div class="form-group">  
                    <label for="exampleInputEmail1" class="para"> Enter Email address </label>  
                    <input type="email" class="form-control form-control-sm hi"  id="exampleInputEmail1" autoComplete="off" aria-describedby="emailHelp" value={user.email} onChange={handelinput} required name="email" />  
          </div> 
                <br/>
<div class="form-group">  
                    <label for="exampleInputPassword1" class="para">Enter Password </label>  
                    <input type="password" class="form-control form-control-sm hi" id="exampleInputPassword1" autoComplete="off" value={user.password} onChange={handelinput} required name="password" />  
          </div>  
                <br/>
